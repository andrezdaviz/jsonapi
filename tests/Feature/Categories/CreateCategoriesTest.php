...
class CreateCategoriesTest extends TestCase
{
    ...
    public function name_is_required()
    {
        ...
        $this->jsonApi()->withData([
            'type' => 'categories',
            'attributes' => $category
        ])->post(route('api.v1.categories.create'))->assertStatus(422)
    ...
    public function slug_is_required()
    {
        ...
        $this->jsonApi()->withData([
            'type' => 'categories',
            'attributes' => $category
        ])->post(route('api.v1.categories.create'))->assertStatus(422)->assertSee('data\/attributes\/slug');
    ...
    public function slug_must_not_start_with_dashes()
    {
        ...
        $category = Category::factory()->raw(['slug' => '-start-dash']);
